...
src/
  ...
  components/       UI reutilizable (ConfirmProvider, ...)
...
Ya hecho (estaba en esta lista, dejo constancia de qué era y cómo quedó): tests automatizados en las dos capas del backend y en dominio+componentes del frontend, suite E2E con Playwright en CI, CI de lint+test+build, backup automatizado de la base de datos, exportación de datos bajo demanda, y autenticación opcional por token. Lo que queda pendiente de verdad:
